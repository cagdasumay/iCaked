...
function filterAllProductsByProvince() {
    ...
    $("#searchAllProductsFilter").val(""); $("#urunlerh1").text(" Ürünler");
    var filterDivs = $(".sortAllProduct");
...
function searchAllProducts(elem) {
    $("#allProductsProvinceFilter option:eq(0),#allProductsFilter  option:eq(0)").prop("selected", true); $("#urunlerh1").text(" Ürünler");
    var key = $(elem).val().toLowerCase();
...
function validateRegister() {
    ...
    setTimeout(function () {
        if (nullCheck & passwordCheck & emailCheck & emailSyntaxCheck & contractCheck) { $("#register-alert-label").slideUp(100); Register(); }
            ...
            if (contractCheck == false) { $("#acceptUserContract").css("box-shadow", "0px 0px 6px 0px red"); $("#register-alert-label").text("Sözleşmeyi kabul etmeniz gerekmektedir."); }
        }
    }, 1000);
}
...
$(document).ready(function () {
    ...
    $("#add-to-cart-btn").click(function () { $(".loading").fadeIn(200); $("#loading-img").attr("src", window.location.protocol + "//" + window.location.host + "/Images/Site/loadmore.gif"); $("#loading-label").text(" Ürün Ekleniyor... "); });
    ...
    $("#contactTel,#istekTasarimTel").mask("(999) 999-99-99");
