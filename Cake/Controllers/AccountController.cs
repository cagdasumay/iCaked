...
namespace Cake.Controllers
{
    public class AccountController : Controller
    {
        ...
        public JsonResult FacebookLogin(String fbID, String nameSurname, String email)
        {
            ...
            if (Session["userinfo"] == null)
            {
                ...
                if (users.Rows.Count == 0)                       // no user - register
                {
                    ...
                    sendMail(email, "iCaked.com - Welcome !", prepareRegisterMail(), null, null);
                }
        ...
        public JsonResult Register(String email_register, String name_register, String surname_register, String password_register)
        {
            ...
            sendMail(email_register, "iCaked.com - Welcome !", prepareRegisterMail(), null, null);
            return Json(result, JsonRequestBehavior.AllowGet);
        }
                    ...
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px dashed #d6d6d6; border-bottom:1px dashed #d6d6d6;"">
                            <div style=""width:100%; padding:20px 0px; float:left; text-align:justify; background:#f2f2f2; text-align:center; margin:20px 0px; border-radius:5px; position:relative;"">
                                ...
                                <div style=""width:90%; margin-left:5%; float:left;"">
                                    <label style=""font-size:22px; color:#92460f; float:left; width:100%; text-align:center; padding-bottom:30px; padding-top:15px;"">Welcome to iCaked</label>
                                    <label style=""font-size:14px; color:#92460f; float:left; width:100%; text-align:center; padding:0px 20px; padding-bottom:30px;"">
                                        Your pastries with iCaked are now very special. <br /> If you want, you can design the cake you want from the Designing section according to your pleasure, you can choose from thousands of design cake and order according to your taste.
                                         Not limited to these, you can order ready made products from Turkey's most exclusive pastries. It is even possible to reach one of the concept party sets specially designed for your birthdays.
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div style=""width:100%; float:left;"">
                            <label style=""float:left; width:100%; font-size:16px; color:#3f2518; text-align:left; padding-top:20px; padding-bottom:10px;"">Special Designs</label>
                " + madeStr + @"
                        </div>
                        <div style=""width:100%; float:left;"">
                            <label style=""float:left; font-size:16px; width:100%; color:#3f2518; text-align:left; padding-top:20px; padding-bottom:10px;"">Products</label>
                ...
                " + productStr + @"
                        ...
                        <div style=""width:100%; float:left; text-align:center; padding:30px 0px; border-bottom:1px dashed #d6d6d6;"">
                            <a href=""https://www.icaked.com"" style=""text-decoration:none;"">
                                <label style=""border-radius:3px; padding:7px 15px; font-size:16px; background:#92460f; color:white; box-shadow: 0px 2px 5px -2px gray;"">You Design Your Cake</label>
                            </a>
                        </div>
        ...
        public JsonResult Forgot(String email)
        {
                            ...
                            <div style=""width:100%; padding:20px 0px; float:left; text-align:justify; background:#f2f2f2; text-align:center; margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:14px; color:#92460f; float:left; width:100%; text-align:center; padding:15px 0px;"">
                                        This e-mail has been sent to update your password for your iCaked.com membership.
                                    </label>
                                    <label style=""font-size:16px; color:#92460f; float:left; width:100%; text-align:center; padding:20px 0px;"">
                                        Your new password is set as <b>" + newPass + @"</b> . <br /><br />
                                        You can change your password from your profile.
                                    </label>
                                    <a href=""https://www.icaked.com"" style=""width:100%; float:left; font-weight:bold; cursor:pointer; font-size:14px;"">Click to Login</a>
                                </div>
                            </div>
                        </div>
            ...
            if (result == true) { sendMail(email, "iCaked.com - Password Renewal", forgotBody, null, null); }
            return Json(result, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult ChangePassword(String oldPass, String newPass)
        {
                        ...
                        <div style=""width:100%; float:left; border-top:1px dashed #d6d6d6; border-bottom:1px dashed #d6d6d6;"">
                            <div style=""width:100%; padding:20px 0px; float:left; text-align:justify; background:#f2f2f2; text-align:center; margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left;"">
                                    ...
                                    <label style=""font-size:16px; color:#92460f; float:left; width:100%; text-align:center; padding:20px 0px;"">
                                        Your new password is set as <b>" + newPass + @"</b> . <br />
                                    </label>
                                    <a href=""https://www.icaked.com"" style=""width:100%; float:left; font-weight:bold; cursor:pointer; font-size:14px;"">Click to login</a>
                                </div>
                            </div>
            ...
            if (result == true)
            {
                ...
                sendMail(((DataRow)Session["userinfo"])["Email"].ToString(), "iCaked.com - Password Change", newPassBody, null, null);
            }
            return Json(result, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            DataTable bakery = dc.DBQueryGetter("select * from ForeignBakeries where Username = '" + bakery_username + "' and Password = '" + bakery_password + "'");
