...
namespace Cake.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            if (Session["city"] == null) { dc.MemoryCacheByQuery("select * from ZipCodes"); return View(); }
            else { return View("Index"); }
        }
        ...
        public ActionResult Kategoriler(string category)
        {
            ...
            String title = " Order " + category + " Now - The Most Delicious " + category;
        ...
        public ActionResult Index(String id)
        {
            if (String.IsNullOrEmpty(id) == false) {
                ...
                else if (id.Length == 2) { id = "000" + id; }
                else if (id.Length == 3) { id = "00" + id; }
                else if (id.Length == 4) { id = "0" + id; }
                id = "94120";
                DataTable dt = dc.DBQueryGetter("select * from ForeignBakeries where Province like '%" + id + "%'");
                if(dt.Rows.Count != 0) { Session["city"] = id; }
                else { TempData["notFound"] = true; return Redirect("/"); }
            }
            if(Session["city"] == null) { return View("Intro"); }
            else { return View(); }
        }
        ...
        public ActionResult MiniBakeries()
        {
            return View();
        }

        public JsonResult GetPriceFromMiniBakery(string bakeryid, string email)
        {
            DataRow bakery = dc.DBQueryGetter("select * from MiniBakeries where BakeryID like '" + bakeryid.ToUpper() + "'").Rows[0];
                ...
                <div style=""width:90%; margin-left:5%; font-family:Helvetica, sans-serif;"">
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        <div style=""padding:40px 0px; width:100%; float:left; background:white;"">
                            <img src=""http://en.icaked.com/Images/Site/main_logo.png"" style=""width:150px; float:left;"" />
                        </div>
                        <div style=""width:100%; float:left; border-top:1px dashed #d6d6d6; border-bottom:1px dashed #d6d6d6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; background:#f2f2f2; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                ...
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:16px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Hello, Thank you for price call. We will get back to you as soon as possible</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:35px;"">You can click on the link below to proceed to the site.</label>
                                    <a href=""http://www.icaked.com"" style=""text-decoration:none;"">
                                        <label style=""border-radius:3px; padding:10px 20px; font-size:18px; background:saddlebrown; color:white; box-shadow: 0px 2px 5px -2px gray;"">Design Your Cake</label>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div style=""background:white; width:100%; float:left; padding:20px 0px;"">
                            <a style=""text-decoration:none; float:right;"" href=""http://en.icaked.com"">
                    ...
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px dashed #d6d6d6; border-bottom:1px dashed #d6d6d6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; background:#f2f2f2; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                ...
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:18px; color:black; float:left; width:100%; text-align:center; padding-bottom:20px;"">Greetings, " + bakery["Name"] + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">A price call has been made to your bakery from iCaked.com</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">User with e-mail " + email + @" would like to know prices of your bakery.</label>
                                    <br /><br />
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">Please feel free to contact us in any case info@icaked.com</label>
                                </div>
                            </div>
                        </div>
                        <div style=""background:white; width:100%; float:left; padding:20px 0px;"">
            ...
            ac.sendMail(email, "iCaked.com - Your Price Call is Taken", userMailBody, null, null);
            ac.sendMail("info@icaked.com", "iCaked.com - Price Call", siteMailBody, null, null);
        ...
        {
            if (String.IsNullOrEmpty(Id) == false) { DataTable bakery = dc.DBQueryGetter("select * from ForeignBakeries where ID = '" + Id + "'"); Session["bakery"] = bakery.Rows[0]; ViewData["bakery"] = bakery.Rows[0]; }
        ...
        public ActionResult Tasarla(string Id, string designID, string saved, string lang)
        {
            if (String.IsNullOrEmpty(lang) == false) { Session["en"] = true; Session["city"] = "Ankara"; }
        ...
        public JsonResult ZipComplete(string term)
        {
            term = term.ToLower().Replace("ş","s").Replace("ı","i").Replace("ç","c").Replace("ö","o").Replace("ü","u").Replace("ğ","g");
            DataTable zips = dc.MemoryCacheByQuery("select * from ZipCodes");

            List<ZipLocation> list = new List<ZipLocation>();

            for(int i = 0; i < zips.Rows.Count; i++)
            {
                DataRow row = zips.Rows[i];
              
                if (row["zip"].ToString().Length == 1) { row["zip"] = "0000" + row["zip"]; }
                else if (row["zip"].ToString().Length == 2) { row["zip"] = "000" + row["zip"]; }
                else if (row["zip"].ToString().Length == 3) { row["zip"] = "00" + row["zip"]; }
                else if (row["zip"].ToString().Length == 4) { row["zip"] = "0" + row["zip"]; }

                if (row["zip"].ToString().ToLower().Contains(term) | row["city"].ToString().ToLower().Contains(term) | row["state"].ToString().ToLower().Contains(term))
                {
                    ZipLocation loc = new ZipLocation();
                    loc.zip = row["zip"].ToString();
                    loc.city = row["city"].ToString();
                    loc.state = row["state"].ToString();
                    list.Add(loc);
                }
            }
        ...
        {
            DataTable bakeries = dc.MemoryCacheByQuery("select * from ForeignBakeries");
                ...
                <div style=""width:90%; margin-left:5%; font-family:Helvetica, sans-serif;"">
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px dashed #d6d6d6; border-bottom:1px dashed #d6d6d6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; background:#f2f2f2; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:16px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Error Notification</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:35px;"">User : " + dc.getUsernameByID(new Guid(userid)) + @"</label>
                        ...
                        <div style=""background:white; width:100%; float:left; padding:20px 0px;"">
                            <a style=""text-decoration:none; float:right;"">
                                <label style=""font-size:13px; float:right; color:black;"">2016 © www.en.icaked.com</label>
                            </a>
                        </div>
                    </div>
                </div>
                ";
                ac.sendMail("info@icaked.com", "iCaked.com - Error Notification", errorBody, null, null);
            }
            catch (Exception e) { }
        }
        ...
        public ActionResult FeedbackForm(FormCollection form)
        {
                ...
                <div style=""width:90%; margin-left:5%; font-family:Helvetica, sans-serif;"">
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px dashed #d6d6d6; border-bottom:1px dashed #d6d6d6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; background:#f2f2f2; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:16px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Hello, Thank you for your comments and suggestions. We will return to you as soon as possible</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:35px;"">You can click on the link below to proceed to the site.</label>
                                    <a href=""http://www.icaked.com"" style=""text-decoration:none;"">
                                        <label style=""border-radius:3px; padding:10px 20px; font-size:18px; background:saddlebrown; color:white; box-shadow: 0px 2px 5px -2px gray;"">Design Your Cake</label>
                                    </a>
                ...
                <div style=""width:90%; margin-left:5%; font-family:Helvetica, sans-serif;"">
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px dashed #d6d6d6; border-bottom:1px dashed #d6d6d6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; background:#f2f2f2; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">Name Surname : " + nameSurname + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">E-Mail : " + email + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Date : " + DateTime.Now + @"</label>
            ...
            ac.sendMail(email, "iCaked.com - Your Feedback is Taken", userMailBody, null, null);
            ac.sendMail("info@icaked.com", "iCaked.com - Feedback", siteMailBody, null, null);
        ...
        public ActionResult IstekFigurForm(FormCollection form, HttpPostedFileBase istekFigurImg)
        {
                    ...
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px dashed #e6e6e6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:14px; color:#444; float:left; width:100%; text-align:center; padding-bottom:30px;"">Hello, the figure has been requested. <br /> The 3D figure you want will be added to the editor shortly. <br /> Thank you.</label>
                                    <label style=""font-size:14px; color:#444; float:left; width:100%; text-align:center; padding-bottom:35px;"">You can click on the link below to proceed to the site.</label>
                                    <a href=""http://www.icaked.com"" style=""text-decoration:none;"">
                                        <label style=""border-radius:3px; padding:10px 20px; font-size:18px; background:#b7613c; color:white; box-shadow: 0px 2px 5px -2px gray;"">Design Your Cake</label>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div style=""background:#f5f5f5; border-radius:5px; width:100%; margin-bottom:50px; float:left; padding:20px 0px;"">
                            <a style=""text-decoration:none; float:right; width:100%; text-align:center;"" href=""http://en.icaked.com"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px bottom #e6e6e6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:50px 0px; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left; text-align:center;"">
                                    <label style=""font-size:18px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Figure Request</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">Name Surname : " + nameSurname + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">E-Mail : " + email + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Date : " + DateTime.Now + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:35px;"">Message : " + content + @"</label>
                                    " + imgStr + @"
                                </div>
                            </div>
                        </div>
            ...
            ac.sendMail(email, "iCaked.com - Figure Request Taken", userMailBody, null, null);
            ac.sendMail("info@icaked.com", "iCaked.com - Figure Request", siteMailBody, null, null);
        ...
        public ActionResult IstekTasarimForm(FormCollection form, IEnumerable<HttpPostedFileBase> istekTasarimImg)
        {
                ...
                <div style=""width:90%; margin-left:5%; font-family:Helvetica, sans-serif;"">
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px solid #e6e6e6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:50px 0px; text-align:center;  margin:20px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:14px; color:#444; float:left; width:100%; text-align:center; padding-bottom:30px;"">Hello, your design request has been received. <br /> <br /> We will return to you as soon as possible to make your design a dream come true</label>
                                    <label style=""font-size:14px; color:#444; float:left; width:100%; text-align:center; padding-bottom:35px;"">You can click on the link below to proceed to the site.</label>
                                    <a href=""http://www.icaked.com"" style=""text-decoration:none;"">
                                        <label style=""border-radius:3px; padding:10px 20px; font-size:16px; background:#b7613c; color:white; box-shadow: 0px 2px 5px -2px gray;"">Design Your Cake</label>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style=""margin:auto; min-width:330px; max-width:600px;"">
                        ...
                        <div style=""width:100%; float:left; border-top:1px solid #e6e6e6;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:50px 0px; text-align:center;  margin:5px 0px; border-radius:5px; position:relative;"">
                                <div style=""width:100%; float:left; text-align:center;"">
                                    <label style=""font-size:18px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Design Cake Request</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">Name Surname : " + nameSurname + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">E-Mail : " + email + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">Tel : " + tel + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:10px;"">City : " + sehir + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:30px;"">Date : " + DateTime.Now + @"</label>
                                    <label style=""font-size:14px; color:black; float:left; width:100%; text-align:center; padding-bottom:35px;"">Message : " + content + @"</label>
                                    " + imgStr + @"
                                </div>
            ...
            ac.sendMail(email, "iCaked.com - Design Request Taken", userMailBody, null, null);
            ac.sendMail("info@icaked.com", "iCaked.com - Design Request", siteMailBody, null, null);
