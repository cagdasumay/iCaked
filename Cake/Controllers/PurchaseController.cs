        ...
        public void sendOrderMails(FormCollection form, bool isPaymentSuccessful)
        {
                        ...
                        <div style=""width:100%; float:left; border-bottom:1px solid #cccccc; margin-bottom:10px; padding-bottom:20px;"">
                            <div style=""width:100%; float:left; margin-bottom:10px; float:left;"">
                                <div style=""width:100%; float:left; margin-bottom:10px;"">
                                    <label style=""float:left; margin-left:10px; font-size:14px; color:#9a4622; margin-right:10px;"">Many : </label>
                                    <label style=""float:left; margin-left:10px; font-size:14px;"">" + order["ProductNumbers"].ToString().Split(' ')[madeIDx] + @" adet</label>
                                </div>
                                <div style=""width:100%; float:left; margin-bottom:10px;"">
                                    <label style=""float:left; margin-left:10px; font-size:14px; color:#9a4622; margin-right:10px;"">Product Name : </label>
                                    <label style=""float:left; margin-left:10px; font-size:14px;"">" + madeProduct["Name"] + @"</label>
                                </div>
                                <div style=""width:100%; float:left; margin-bottom:10px;"">
                                    <label style=""float:left; margin-left:10px; font-size:14px; color:#9a4622; margin-right:10px;"">Product Content : </label>
                                    <label style=""float:left; margin-left:10px; font-size:14px;"">" + order["Inside"] + @"</label>
                                </div>
                                <div style=""width:100%; float:left; margin-bottom:10px;"">
                                    <label style=""float:left; margin-left:10px; font-size:14px; color:#9a4622; margin-right:10px;"">Product Price : </label>
                        ...
                        <div style =""width:100%; float:left; border-top:1px dashed #3f2518;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; text-align:center; margin:20px 0px; border-radius:5px; position:relative; background:#f2f2f2;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:20px; color:#9a4622; float:left; width:100%; text-align:center; padding-bottom:20px;"">Your order has arrived to us</label>
                                    ...
                                    <label style=""font-size:12px; color:#9a4622; float:left; width:100%; text-align:center; padding-bottom:20px;"">The details of your order are given below. </label>
                                    <a href=" + orderlink + @" style=""font-size:12px; float:left; width:100%; text-align:center; padding-bottom:20px; color:black;"">Here you can track your order status. </a>
                                </div>
                            </div>
                        </div>";
            ...
            string bakeryDeclaration = @"
                        <div style =""width:100%; float:left; border-top:1px dashed #3f2518;"">
                            <div style=""width:100%; float:left; text-align:justify; padding:40px 0px; text-align:center; margin:20px 0px; border-radius:5px; position:relative; background:#f2f2f2;"">
                                <div style=""width:100%; float:left;"">
                                    <label style=""font-size:20px; color:#9a4622; float:left; width:100%; text-align:center; padding-bottom:20px;"">Hello " + bakery["Name"] + @"</label>
            ...
            String customerMailBody = @"
                 <div style=""width:90%; margin-left:5%; font-family:Helvetica, sans-serif;"">
                    ...
                    + customerDeclaration +
                        @"<label style=""float:left; font-size:18px; padding:15px 0px; padding-top:0px; width:100%; border-bottom:1px dashed #3f2518; margin-top:30px; text-align:left; color:#9a4622; line-height:initial;"">Order Info</label>
                        <div style=""width:100%; float:left; text-align:left; padding:15px 0px;"">
                            <div style=""width:20%; float:left; min-width:130px; color:#9a4622;"">
                                ...
                                <label style=""font-weight:bold; width:100%; float:left; padding-bottom:15px;"">Order Date : </label>
                        ...
                        <label style=""float:left; font-size:18px; padding:15px 0px; padding-top:0px; width:100%; border-bottom:1px dashed #3f2518; margin-top:30px; text-align:left; color:#9a4622; line-height:initial;"">Contact Info</label>
                        <div style=""width:100%; float:left; text-align:left; padding:15px 0px;"">
                        ...
                        <label style=""float:left; font-size:18px; padding:15px 0px; padding-top:0px; width:100%; border-bottom:1px dashed #3f2518; margin-top:30px; text-align:left; color:#9a4622; line-height:initial;"">Product Info</label>
                        <div style=""width:100%; float:left; text-align:left; padding:15px 0px;"">
