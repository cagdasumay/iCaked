...
namespace Cake.Controllers
{
    public class ObjectController : Controller
    {
        ...
        public String CalculateDesignPriceJson(String bakeryID, String objStr)
        {
            ...
            DataRow bakery = dc.MemoryCacheByQuery("select * from Bakeries where BakeryID = '" + new Guid(bakeryID) + "'").Rows[0];
            String basePrice = "";
        ...
        {
            DataTable dt_bakeries = dc.MemoryCacheByQuery("select * from Bakeries where Province = '" + ProvinceCode + "' and BakeryID <> '98E94E0A-C764-4F99-A2F1-F4915631A891' and BakeryID <> '811c68da-edad-4de6-977e-b20f1cd1c833'");
